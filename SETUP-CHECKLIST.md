...
2. Clone your fork and install dependencies:
   ...
   npm run dev
   ```
3. Confirm that Vite starts and open the local URL shown in the terminal.

The repository contains the Vue project and `npm run dev` starts the
development server.
...
- [ ] Repo forked, cloned, and `npm run dev` starts the Vite development server
